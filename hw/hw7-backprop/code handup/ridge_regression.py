...
class RidgeRegression(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, l2_reg=1, step_size=.005,  max_num_epochs = 5000):
        ...
        self.l2_reg = nodes.ValueNode(node_name="l2_reg") # to hold the reg parameter (scalar)
        ...
        self.objective = nodes.SumNode(a=self.squareloss, b=self.l2penalty, node_name="objective")
